"""
Django settings for soft_silence_40909 project.
...
ROOT_URLCONF = 'soft_silence_40909.urls'
...
WSGI_APPLICATION = 'soft_silence_40909.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "soft_silence_40909 API",
    "DESCRIPTION": "API documentation for soft_silence_40909 App",
    "VERSION": "v1",
}
